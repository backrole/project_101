...
class FillPermissionsForKeperluan extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForKeperluan constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.keperluan',
            'admin.keperluan.index',
            'admin.keperluan.create',
            'admin.keperluan.show',
            'admin.keperluan.edit',
            'admin.keperluan.delete',
        ]);
